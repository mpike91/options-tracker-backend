...
{
    /// <inheritdoc />
    public partial class AddWeeklyOptionsModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImpliedVol = table.Column<double>(type: "float", nullable: false),
                    ...
                    Vega = table.Column<double>(type: "float", nullable: false),
                    Rho = table.Column<double>(type: "float", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OptionExpirations", x => x.Id);
                }
            );
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "MarketHistories");

            migrationBuilder.DropTable(name: "OptionChains");

            migrationBuilder.DropTable(name: "OptionExpirations");

            migrationBuilder.DropTable(name: "WeeklyStocks");
